...
const AnsiString VERSION =
    "5.16.01"; // don't forget to change version.txt on easy68k.com
...
struct opDescriptor {
  ...
  char size;    // Size of index register (WORD or LONG, see below)
                ...
                // Also used to prevent MOVEQ, ADDQ & SUBQ optimizations (see
                // OPPARSE.CPP)
...
const int REG_LIST_SYM =
    0x04;                   /* Set for symbols defined by the REG directive */
