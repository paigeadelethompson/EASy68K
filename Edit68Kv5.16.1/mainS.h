...
public: // User declarations
  ...
  void __fastcall FindDialogFind(AnsiString findText, bool wholeWord,
                                 bool matchCase);
  void __fastcall ReplaceDialogReplace();

  // variable declarations
  int iNewFiles; // keeps track of how many new files have been opened and the
                 // number is used with the naming of new files ex. "untitled1"
