...
// operations
struct FileInfo {
  AnsiString CurrentFile; // contains the path to the current file loaded in a
                          // particular instance of TextStuff
  int TabType;
  int TabSize;
  bool CreateList;
  // bool SourceOpen;
  bool ListOpen;
  bool Modified;
  bool IsSource; // true if a particular instance of TextStuff is a source file,
                 // false for any other file type loaded
...
class TTextStuff : public TForm {
  ...
  void __fastcall SourceTextMouseUp(TObject *Sender, TMouseButton Button,
                                    TShiftState Shift, int X, int Y);
  void __fastcall SourceTextMouseDown(TObject *Sender, TMouseButton Button,
                                      TShiftState Shift, int X, int Y);
  ...
  void __fastcall SourceTextMouseMove(TObject *Sender, TShiftState Shift, int X,
                                      int Y);
  void __fastcall SourceTextProtectChange(TObject *Sender, int StartPos,
...
public:  // User declarations
  ...
  int __fastcall GetFirstPos(
      int line); // returns start of line in Char positions
  int __fastcall GetLastPos(int line); // returns end of line in Char positions
  void __fastcall NewProject(
      AnsiString Type); // reset all controls to new project
