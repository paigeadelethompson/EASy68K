...
The routines are :  BPoint(); ~BPoint(); int getId(); void setId(int); int
getType(); void setType(int); long getTypeId(); void setTypeId(long); int
getOperator(); void setOperator(int); long getValue(); void setValue(long); int
getReadWrite(); void setReadWrite(int); long getSize(); void setSize(long); bool
isBreak(); bool isEnabled(); void isEnabled(bool);
...
bool BPoint::isBreak() {
  ...
  switch (op) {
  case EQUAL_OP:
    finalCondition = (valueFound == value);
    break;
  case NOT_EQUAL_OP:
    finalCondition = (valueFound != value);
    break;
