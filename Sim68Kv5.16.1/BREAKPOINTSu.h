...
class TBreaksFrm : public TForm {
  ...
  void __fastcall RegColumnMoved(TObject *Sender, int FromIndex, int ToIndex);
  void __fastcall AddrColumnMoved(TObject *Sender, int FromIndex, int ToIndex);
  void __fastcall ExprColumnMoved(TObject *Sender, int FromIndex, int ToIndex);
  void __fastcall RegRowMoved(TObject *Sender, int FromIndex, int ToIndex);
  void __fastcall RegTopLeftChanged(TObject *Sender);
  void __fastcall AddrTopLeftChanged(TObject *Sender);
  void __fastcall AddrRowMoved(TObject *Sender, int FromIndex, int ToIndex);
  void __fastcall ExprRowMoved(TObject *Sender, int FromIndex, int ToIndex);
