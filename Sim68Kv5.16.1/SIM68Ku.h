...
class TForm1 : public TForm {
  ...
  void __fastcall breakPMouseDown(TObject *Sender, TMouseButton Button,
  ...
  void __fastcall regA7KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regUSKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA8KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA6KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA5KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA4KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA3KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA2KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA1KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall regA0KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
...
private: // User declarations
  ...
  void __fastcall WmDropFiles(
      TWMDropFiles &Message); // handle drag-n-drop from explorer
