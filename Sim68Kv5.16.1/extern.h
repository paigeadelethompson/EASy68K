...
// saves weather the ChangeDisplaySettingsEx() and other multi monitor apis
// exist
extern bool MultimonitorAPIsExist;

// what screen to use for full screen output   0 = primary  1 and up =
// secondaries
...
// function pointers to APIs that don't always exist. (for compatibility with
// 95)
typedef HRESULT(CALLBACK *CHANGEDISPLAYSETTINGSEXAPROC)(LPCTSTR, LPDEVMODEA,
                                                        HWND, DWORD, LPVOID);
extern CHANGEDISPLAYSETTINGSEXAPROC ChangeDisplaySettingsExAPtr;
typedef HRESULT(CALLBACK *ENUMDISPLAYSETTINGSEXAPROC)(LPCTSTR, DWORD, LPDEVMODE,
                                                      DWORD);
extern ENUMDISPLAYSETTINGSEXAPROC EnumDisplaySettingsExAPtr;
typedef HRESULT(CALLBACK *ENUMDISPLAYDEVICESAPROC)(LPCTSTR, DWORD,
                                                   PDISPLAY_DEVICE, DWORD);
