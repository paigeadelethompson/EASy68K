...
class THardware : public TForm {
  ...
  void __fastcall addrKeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  ...
  void __fastcall pb0KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  ...
  void __fastcall pb0MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb0KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb1KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb1KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  ...
  void __fastcall pb1MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb2KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb2KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  ...
  void __fastcall pb2MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb3KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb3KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  ...
  void __fastcall pb3MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb4KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb4MouseDown(TObject *Sender, TMouseButton Button,
                               TShiftState Shift, int X, int Y);
  void __fastcall pb4KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb4MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb5KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb5MouseDown(TObject *Sender, TMouseButton Button,
                               TShiftState Shift, int X, int Y);
  void __fastcall pb5KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb5MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb6KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb6MouseDown(TObject *Sender, TMouseButton Button,
                               TShiftState Shift, int X, int Y);
  void __fastcall pb6KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb6MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pb7KeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb7MouseDown(TObject *Sender, TMouseButton Button,
                               TShiftState Shift, int X, int Y);
  void __fastcall pb7KeyUp(TObject *Sender, WORD &Key, TShiftState Shift);
  void __fastcall pb7MouseUp(TObject *Sender, TMouseButton Button,
                             TShiftState Shift, int X, int Y);
  void __fastcall pbAddrKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
