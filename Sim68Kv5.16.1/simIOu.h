...
public: // User declarations
  ...
  __fastcall ~TsimIO();
  void __fastcall displayFileDialog(long *mode, int A1, int A2, int A3,
                                    short *result);
  ...
  void __fastcall scrollRect(ushort r, ushort c, ushort w, ushort h,
                             ushort dir);
  ...
  void __fastcall sendNet(int settings, char *data, char *remoteIP, int *count,
                          int *result);
  void __fastcall receiveNet(int settings, char *buffer, int *count,
                             char *senderIP, int *result);
  void __fastcall sendPortNet(long *D0, long *D1, char *data, char *remoteIP);
  void __fastcall receivePortNet(long *D0, long *D1, char *buffer,
                                 char *senderIP);
