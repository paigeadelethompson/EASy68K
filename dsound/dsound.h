...
extern HRESULT WINAPI DirectSoundCaptureCreate(LPCGUID, LPDIRECTSOUNDCAPTURE *,
                                               LPUNKNOWN);
...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
  ...
  STDMETHOD(CreateSoundBuffer)(THIS_ LPCDSBUFFERDESC, LPDIRECTSOUNDBUFFER *,
                               LPUNKNOWN) PURE;
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
  ...
  STDMETHOD(CreateCaptureBuffer)(THIS_ LPCDSCBUFFERDESC,
                                 LPDIRECTSOUNDCAPTUREBUFFER *, LPUNKNOWN) PURE;
...
// The function completed successfully, but we had to substitute the 3D
// algorithm
